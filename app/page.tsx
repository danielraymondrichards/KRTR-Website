  ...
  return (
    <div>
      ...
      <main className="master-css-grid">
        ...
        {/* HERO STORY */}
        <section className="col-span-3 bg-gray-200 rounded-lg overflow-hidden">
          {heroStory ? (
            <>
        ...
        {/* HS Banner Ad */}
        <section className="col-span-3 bg-yellow-300 rounded-lg">HS Banner Ad</section>

        {/* WEATHER BAR */}
        <section className="col-span-3 bg-blue-200 rounded-lg">Weather Bar</section>

        {/* Top Stories */}
        <div className="col-span-2 grid grid-cols-2 gap-4">
          {topStories.length > 0 ? (
            topStories.map((story) => (
              <div key={story.id} className="bg-white p-4 shadow">
